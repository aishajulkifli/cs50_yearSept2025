...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # Determine whether person has the trait
        ...
        # CASE 1:
        # Person has no parents listed
        if mother is None and father is None:

            # Use unconditional gene probability
            gene_prob = PROBS["gene"][genes]

        # CASE 2:
        # Person has parents listed
        else:

            # Function to calculate probability
            # that a parent passes the gene
            ...
            # Calculate probability child gets
        ...
        # Probability of exhibiting trait
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        gene_total = sum(
            probabilities[person]["gene"].values()
        )
        ...
        trait_total = sum(
            probabilities[person]["trait"].values()
        )
