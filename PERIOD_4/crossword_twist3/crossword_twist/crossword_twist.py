...
class CrosswordCreator():
    ...
    def letter_grid(self, assignment):
        """
        Return a 2D array of letters for a given assignment.
        """
        letters = [
            [None] * self.crossword.width
...
def main():
    ...
    if theme == "animals":
        words = "data/animals.txt"

    elif theme == "food":
        words = "data/foods.txt"

    elif theme == "sports":
        words = "data/sports.txt"

    elif theme == "science":
        words = "data/science.txt"

    else:
        print("Invalid theme.")
        return

    crossword = Crossword("data/structure_theme.txt", words)
...
# python crossword_twist.py data/structure_theme.txt data/animals.txt
