...
class Maze:
	...
	def calc_manhattan(self, state: tuple):
		# TODO
		# calculate the manhattan distance of this state to exit of the maze $
		x1, y1 = state
		x2, y2 = self.end
...
class GBfsFrontier:
	...
	def remove(self, current: Node|None=None, im: Imageclass|None=None):
		...
		best_node = min(self.frontier, key=lambda node: node.hn + node.gn)
